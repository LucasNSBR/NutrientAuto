...
namespace NutrientAuto.Community.Tests.CommandHandlers.FoodTableAggregate
{
    [TestClass]
    public class FoodTableCommandHandlerTests
    {
        #region Arrange
        ...
        public ILogger<FoodTableCommandHandler> GetLogger()
        {
            Mock<ILogger<FoodTableCommandHandler>> mock = new Mock<ILogger<FoodTableCommandHandler>>();
